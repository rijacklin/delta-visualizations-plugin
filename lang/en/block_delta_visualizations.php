...
$string['filterrangemonthly'] = 'Last month';
$string['filterrangeyearly'] = 'Last year';
...
$string['settingsfeedbackgoal'] = 'Personalized-feedback uniqueness goal';
$string['settingsfeedbackgoal_desc'] = 'The minimum acceptable uniqueness percentage between feedback messages. Valid values are from 0 to 100.';
$string['settingsinteractionthreshold'] = 'Weekly interaction threshold';
$string['settingsinteractionthreshold_desc'] = 'The minimum average number of teacher interactions per week used by Consistent Use of LMS.';
$string['settingstimelyfeedbackdays'] = 'Timely feedback response window';
$string['settingstimelyfeedbackdays_desc'] = 'The maximum number of days allowed between a student submission and feedback. Valid values are from 0 to 31.';
